            ...
            fetchData(url.geo(searchField.value), function(locations){
                ...
                for (const {name,lat,lon,country,state} of locations){
                    ...
                    searchItem.innerHTML=`                        
                        <span class="n-icon">location_on</span>

                        <div>
                            <p class="item-title">${name}</p>

                            <p class="lebel-2 item-subtitle">${state || ""} ${country}</p>
                        </div>
...
export const updateWeather=function(lat,lon){
    ...
    fetchData(url.currentWeather(lat,lon),function(currentWeather){
        ...
        card.innerHTML=`
            ...
            <ul class="meta-list">
            <li class="meta-item">
                <span class="n-icon">calender_today</span>
            ...
            card.innerHTML=`                
              ...
              <div class="highlight-list">
                ...
                <div class="card card-sn highlight-card two">
                  ...
                  <div class="card-list">
                    <div class="card-item">
                      <span class="n-icon">clear_day</span>
                      <div>
                    ...
                    <div class="card-item">
                      <span class="n-icon">clear_night</span>
                      <div>
                ...
                <div class="card card-sn highlight-card">
                  ...
                  <div class="wrapper">
                    <span class="n-icon">humidity_percentage</span>
                ...
                <div class="card card-sn highlight-card">
                  ...
                  <div class="wrapper">
                    <span class="n-icon">airwave</span>
                ...
                <div class="card card-sn highlight-card">
                  ...
                  <div class="wrapper">
                    <span class="n-icon">visibility</span>
                ...
                <div class="card card-sn highlight-card">
                  ...
                  <div class="wrapper">
                    <span class="n-icon">thermostat</span>
        ...
        fetchData(url.forecast(lat,lon),function(forecast){
            ...
            for (const [index,data] of forecastList.entries()){
                ...
                tempLi.innerHTML=`
                    <div class="card card-sn slider-card">
                ...
                windLi.innerHTML=`                    
                  <div class="card card-sn slider-card">
                    ...
                    />
                    <p class="body-3">${parseInt(module.nps_to_kmh(windSpeed))} km/h</p>
                  </div>
                `;
